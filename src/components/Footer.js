  ...
  return (
    <div className="footer__container">
      <div className="footer__icons">
        <a href="https://www.instagram.com/cyberpierri" target="_blank"><img src={theme === "light" ? igLight : igDark} alt="Instagram logo" /></a>
        <a href="https://www.linkedin.com/in/danielpierri/" classname="footer__li" target="_blank"><img src={theme === "light" ? liLight : liDark} alt="LinkedIn logo" /></a>
        <a href="https://github.com/danielpierri" classname="footer__gh" target="_blank"><img src={theme === "light" ? ghLight : ghDark} alt="GitHub logo" /></a>
      </div>
